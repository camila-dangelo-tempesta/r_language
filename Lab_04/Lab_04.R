#### LABORATÓRIO 04: Segmentação de Clientes com Base em Análise RFM (Recência, Frequência e Valor Monetário) ####

#### 1. Working Directory ####
# Configurando o diretório de trabalho
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_06")
getwd()
...
# Estratégia: Vamos apenas excluir os registros com valores ausentes
...
calcula_rfm <- function(x){
  ...
  # Removendo transações com valores acima do 3º Quartil e abaixo do Quartil 1 
...
#### 7. Machine Learning: Clusterização Kmeans ####
