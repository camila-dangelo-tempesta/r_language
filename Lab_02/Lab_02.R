...
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_04")
getwd()
...
# Combina os dados anteriores com dados do PIB pela coluna Country
...
#### 5. Data Cleaning ####
##### 5.1 Cleaning and Preparing the First Combined Dataset ####
...
##### 5.2 Cleaning and Preparing the Second Combined Dataset ####
...
##### 5.3 Cleaning and Preparing the Third Combined Dataset ####
...
##### 5.4 Cleaning and preparing the four of the combined dataset ####
...
##### 5.5 Cleaning and Preparation of the Fifth Combined Dataset ####
...
##### 5.6 Cleaning and Preparing the Sixth Combined Dataset ####
