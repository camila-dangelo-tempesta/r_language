#### LABORATÓRIO 05: Time Series Analysis in the Market Financial ####
...
#### 2. Imports ####
# http://www.quantmod.com (pacote modelagem financeira quantitativa)
...
# se o getSymbols apresentar erro, usar este comando
